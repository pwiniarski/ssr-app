function template(title, content = "", hashes){
    ...
    let page = `<!DOCTYPE html>
                ...
                <head>
                  ...
                  <title> ${title} </title>
                  <link href="/static/css/main.${hashes[0]['main.css']}.chunk.css" rel="stylesheet">
                </head>
                <body>
    ...
    <script src="/static/js/2.${Object.values(hashes[3])}.chunk.js"></script>
    <script src="/static/js/main.23facdba.chunk.js"></script>
                </body>
                </html>
                `;
